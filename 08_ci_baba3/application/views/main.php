    	...
    	<div class="panel">
			...
			<div class="backgrounds">
				...
				<div class="item item_1">
					<img src="<?php echo base_url(); ?>/assets/images/slider/02.jpg" alt="Slider 01" />
				</div><!-- /item -->
				
				<div class="item item_2">
					<img src="<?php echo base_url(); ?>/assets/images/slider/03.jpg" alt="Slider 02" />
				</div><!-- /item -->
				
				<div class="item item_3">
					<img src="<?php echo base_url(); ?>/assets/images/slider/01.jpg" alt="Slider 03" />
				</div><!-- /item -->
    ...
    <div id="templatemo_main">
   		<div id="sidebar" class="float_l">
            ...
            <div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<div class="bs_box">
                    	<a href="#"><img src="<?php echo base_url(); ?>/assets/images/templatemo_image_01.jpg" alt="Image 01" /></a>
                        <h4><a href="#">Donec nunc nisl</a></h4>
                        <p class="price">$10</p>
                        <div class="cleaner"></div>
                    </div>
                    <div class="bs_box">
                    	<a href="#"><img src="<?php echo base_url(); ?>/assets/images/templatemo_image_01.jpg" alt="Image 02" /></a>
                        <h4><a href="#">Aenean eu tellus</a></h4>
                        <p class="price">$12</p>
                        <div class="cleaner"></div>
                    </div>
                    <div class="bs_box">
                    	<a href="#"><img src="<?php echo base_url(); ?>/assets/images/templatemo_image_01.jpg" alt="Image 03" /></a>
